...
function loadData(){
	...
	Promise.all([
      d3.json("data2/us_cont_states.topojson"),
      d3.json("data2/departamentos.topojson"),
      d3.json("data2/countries.geojson"),
      d3.csv("data2/remittance_source_destination.csv"),
      d3.csv("data2/remittance_single.csv"),
    ])
